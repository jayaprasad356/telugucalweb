...
if (isset($_POST['btnUpdate'])) {
    ...
    if (!empty($categories_result)) {
        ...
        $error['add_menu'] = " <span class='label label-success'>Month Festival Updated Successfully</span>";
    }
...
$sql_query = "SELECT * FROM `month_festivals` WHERE id = '$ID'";
$db->sql($sql_query);
$res = $db->getResult();
...
<section class="content-header">
	<h1>
		Edit Month Festival<small><a href='month_festivals.php'><i class='fa fa-angle-double-left'></i>&nbsp;&nbsp;&nbsp;Back to Month Festivals</a></small></h1>
    ...
    <div class="row">
        <div class="col-md-8">
            <div class="box box-primary">
                ...
                <!-- /.box-header -->
                <!-- form start -->
                <form id="edit_festival_form" method="post" enctype="multipart/form-data">
                    <div class="box-body">
                            <div class="row">
