...
if (isset($_POST['btnUpdate'])) {
    ...
    if (!empty($categories_result)) {
        ...
        $error['add_menu'] = " <span class='label label-success'>notifications Updated Successfully</span>";
    }
    if (isset($_FILES['image']['size']) && $_FILES['image']['size'] != 0 && $_FILES['image']['error'] == 0 && !empty($_FILES['image'])) {
        ...
        if ($update_result == 1) {
            $error['update_menu'] = " <section class='content-header'><span class='label label-success'>notifications updated Successfully</span></section>";
        } else {
...
<h1>Edit notifications <small><a href='notifications.php'> <i class='fa fa-angle-double-left'></i>&nbsp;&nbsp;&nbsp;Back to notifications</a></small></h1>
    ...
    <div class="row">
        <div class="col-md-6">
            <div class="box box-primary">
                ...
                <!-- /.box-header -->
                <!-- form start -->
                <form id='edit_notifications_form' method="post" enctype="multipart/form-data">
                    <div class="box-body">
                        <div class="row">
