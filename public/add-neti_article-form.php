...
if (isset($_POST['btnAdd'])) {
       ...
       if (!empty($title) && !empty($description)) {
            ...
            $sql_query = "INSERT INTO neti_articles (title,description,image)VALUES('$title','$description','$upload_image')";
            $db->sql($sql_query);
            $result = $db->getResult();
            if (!empty($result)) {
                $result = 0;
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="box box-primary">
                ...
                <!-- /.box-header -->
                <!-- form start -->
                <form name="add_neti_article_form" method="post" enctype="multipart/form-data">
                    <div class="box-body">
                           <div class="row">
...
<script>
    $('#add_neti_article_form').validate({
