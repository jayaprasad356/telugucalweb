...
if (isset($_POST['btnUpdate'])) {
    ...
    $sql = "UPDATE holidays SET year='$year',month='$month',title='$title',description='$description',title_description='$title_description' WHERE id = '$ID'";
    $db->sql($sql);
    $categories_result = $db->getResult();
    if (!empty($categories_result)) {
        $error['add_menu'] = " <span class='label label-danger'>Failed</span>";
    } else {
        $error['add_menu'] = " <span class='label label-success'>Holiday Updated Successfully</span>";
    }
...
$sql_query = "SELECT * FROM `holidays` WHERE id = '$ID'";
$db->sql($sql_query);
$res = $db->getResult();
...
<section class="content-header">
	<h1>
		Edit Holidays<small><a href='holidays.php'><i class='fa fa-angle-double-left'></i>&nbsp;&nbsp;&nbsp;Back to Holidays</a></small></h1>
    ...
    <div class="row">
        <div class="col-md-8">
            <div class="box box-primary">
                ...
                <!-- /.box-header -->
                <!-- form start -->
                <form id="edit_holiday_form" method="post" enctype="multipart/form-data">
                    <div class="box-body">
                            <div class="row">
