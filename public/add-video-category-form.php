...
if (isset($_POST['btnAdd'])) {
        ...
        if (!empty($name)) {
            $result = $fn->validate_image($_FILES["category_image"]);
                ...
                // upload new image
                $upload = move_uploaded_file($_FILES['category_image']['tmp_name'], 'upload/video-category/' . $menu_image);
        
                // insert new data to menu table
                $upload_image = 'upload/video-category/' . $menu_image;
            ...
            if ($result == 1) {
                $error['add_category'] = " <section class='content-header'><span class='label label-success'>Video Added Successfully</span></section>";
            } else {
...
<section class="content-header">
    <h1>Add Video Category<small><a href='video-category.php'> <i class='fa fa-angle-double-left'></i>&nbsp;&nbsp;&nbsp;Back to Category</a></small></h1>
