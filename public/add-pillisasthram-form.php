       ...
       if (!empty($title) && !empty($description)) {
            ...
            if ($result == 1) {
                ...
                $error['add_pillisasthram'] = "<section class='content-header'>
                                                <span class='label label-success'>Kaki Sasthram Added Successfully</span> </section>";
            } else {
    ...
    <div class="row">
        <div class="col-md-10">
            ...
            <div class="box box-primary">
                ...
                <!-- /.box-header -->
                <!-- form start -->
                <form name="add_pilliisasthram_form" method="post" enctype="multipart/form-data">
                    <div class="box-body">
                           <div class="row">
...
<script>
    $('#add_kakisasthram_form').validate({
