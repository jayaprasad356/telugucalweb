...
if (isset($_POST['btnAdd'])) {
       ...
       if (!empty($month) && !empty($year) && !empty($title) && !empty($description) && !empty($title_description)) {
            ...
            $sql_query = "INSERT INTO important_days (month,year,title,description,title_description)VALUES('$month','$year','$title','$description','$title_description')";
            $db->sql($sql_query);
            $result = $db->getResult();
            if (!empty($result)) {
                $result = 0;
            ...
            if ($result == 1) {
                ...
                $error['add_important_day'] = "<section class='content-header'>
                                                <span class='label label-success'>Important Day Added Successfully</span> </section>";
            } else {
                $error['add_important_day'] = " <span class='label label-danger'>Failed</span>";
            }
            }
        }
?>
<section class="content-header">
    <h1>Add Important Day<small><a href='important_days.php'> <i class='fa fa-angle-double-left'></i>&nbsp;&nbsp;&nbsp;Back to Important Day</a></small></h1>

    <?php echo isset($error['add_important_day']) ? $error['add_important_day'] : ''; ?>
    <ol class="breadcrumb">
    ...
    <div class="row">
        <div class="col-md-8">
            ...
            <div class="box box-primary">
                ...
                <!-- /.box-header -->
                <!-- form start -->
                <form name="add_important_day_form" method="post" enctype="multipart/form-data">
                    <div class="box-body">
                            <div class="row">
...
<script>
    $('#add_important_day_form').validate({
