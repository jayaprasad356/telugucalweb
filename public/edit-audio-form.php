   ...
   if (!empty($title) && !empty($lyrics))
    {
		...
		if (!empty($update_result)) {
			...
			$error['update_audio'] = " <section class='content-header'><span class='label label-success'>Audio updated Successfully</span></section>";
			} else {
...
<section class="content-header">
	<h1>
		Edit Audio<small><a href='audio.php'><i class='fa fa-angle-double-left'></i>&nbsp;&nbsp;&nbsp;Back to Audio</a></small></h1>
