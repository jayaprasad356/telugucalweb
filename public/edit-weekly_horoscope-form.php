...
if (isset($_POST['btnEdit'])) {
	...
	{
             $sql_query = "UPDATE weekly_horoscope SET rasi='$rasi',description='$description',title='$title',year='$year',month='$month',week='$week',title_description='$title_description' WHERE id =$ID";
			 $db->sql($sql_query);
			 $res = $db->getResult();
			...
			// check update result
			if ($update_result == 1) {
				   $error['update_weekly_horoscope'] = " <section class='content-header'><span class='label label-success'>weekly Horoscope updated Successfully</span></section>";
			} else {
				$error['update_weekly_horoscope'] = " <span class='label label-danger'>Failed to update</span>";
			}
		}
	} 
...
$sql_query = "SELECT * FROM weekly_horoscope WHERE id =" . $ID;
$db->sql($sql_query);
$res = $db->getResult();
...
<section class="content-header">
	<h1>
		Edit Weekly Horoscope<small><a href='weekly.php'><i class='fa fa-angle-double-left'></i>&nbsp;&nbsp;&nbsp;Back to weekly Horoscope</a></small></h1>
	<small><?php echo isset($error['update_weekly_horoscope']) ? $error['update_weekly_horoscope'] : ''; ?></small>
	<ol class="breadcrumb">
	...
	<div class="row">
		<div class="col-md-10">
			...
			<div class="box box-primary">
				...
				<!-- /.box-header -->
				<!-- form start -->
				<form id="edit_weekly_horoscope_form" method="post" enctype="multipart/form-data">
					<div class="box-body">
					<div class="row">
