...
if (isset($_POST['btnAdd'])) {
       ...
       if (!empty($month) && !empty($year) && !empty($title) && !empty($description) && !empty($title_description)) {
            ...
            $sql_query = "INSERT INTO month_festivals (month,year,title,description,title_description)VALUES('$month','$year','$title','$description','$title_description')";
            $db->sql($sql_query);
            $result = $db->getResult();
            if (!empty($result)) {
                $result = 0;
            ...
            if ($result == 1) {
                ...
                $error['add_month_festival'] = "<section class='content-header'>
                                                <span class='label label-success'>Month Festival Added Successfully</span> </section>";
            } else {
                $error['add_month_festival'] = " <span class='label label-danger'>Failed</span>";
            }
            }
        }
?>
<section class="content-header">
    <h1>Add Month Festival<small><a href='month_festivals.php'> <i class='fa fa-angle-double-left'></i>&nbsp;&nbsp;&nbsp;Back to  Month Festivals</a></small></h1>

    <?php echo isset($error['add_month_festival']) ? $error['add_month_festival'] : ''; ?>
    <ol class="breadcrumb">
    ...
    <div class="row">
        <div class="col-md-8">
            ...
            <div class="box box-primary">
                ...
                <!-- /.box-header -->
                <!-- form start -->
                <form name="add_month_festival_form" method="post" enctype="multipart/form-data">
                    <div class="box-body">
                            <div class="row">
...
<script>
    $('#add_month_festival_form').validate({
